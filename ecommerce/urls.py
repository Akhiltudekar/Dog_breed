...
urlpatterns = [
    ...
    path('donor-register', views.donor_register_view, name='donor-register'),
    ...
    path('admin-donors', views.admin_donors_view, name='admin-donors'),
    ...
    path('view-hospitals', views.hospitals_view, name='view-hospitals'),
    path('view-donors', views.donors_view, name='view-donors'),
    path('breed-detector', views.breed_detector, name='breed-detector'),
